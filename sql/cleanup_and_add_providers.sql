-- Clean up and re-add providers with proper UUIDs
-- Run this in Supabase SQL Editor

-- First, clean up any existing test providers that might have been created incorrectly
...
-- Now run the add_default_providers.sql script
-- Or you can copy the content from add_default_providers.sql below:
...
-- Verify providers were created with proper UUIDs
